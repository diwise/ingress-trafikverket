...
func MainReturnError() {
	mockService := setupMockServiceReturnError()
	defer mockService.Close()
...
func TestPublishWeatherStationStatus(t *testing.T) {
	...
	err := publishWeatherStationStatus(weather, topic)
...
func setupMockServiceReturnError() *httptest.Server {
